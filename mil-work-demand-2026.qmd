...
subtitle: Military Pentathlon Jørstadmoen 2026
...
## Military work demands and Military Pentathlon - The Link {.smaller background-color="#107895"}
...
**1. part - Military Pentathlon**  

- Brief background of Military Pentathlon  

- The link to military working demand  

- Military pentathlon in a military context  


**2. part - Challenges and Physical fitness**  
...
**3. part - Training and military readiness**

- Training principles and training strategies (during deployment)<br>to preserve physical fitness and military readiness  
...
Switching to part two looking into what are we actually training for with these exercises from military pentathlon....

2 part; Then from her and beyond military pentathlon, physical capacitites are put into a broader military context. With the purpose of emphasizing the importance of physical fitness to improve and sustain military readiness

3. part benefit
- benefit of sustaining high physical fitness for short and long term as a soldier...



:::

## Military work demands and Military Pentathlon - The Link {background-color="#107895"}

###  The beginning of Military Pentathlon

:::: {.columns}

::: {.column width="50%"}

::: {.absolute top=250 left=-120}

- 1940s' captain *Henri Debrus* promoted the idea

- Modified the original pentathlon

- The characteristics of the military pentathlon-<br>closely related to military demands [@baitan_2021]{style="font-size: 70%;"}
...
![](images/mil-pent.png){.absolute height="350" top=250 right=-160}
...
Startet on the beginning of the 1900th century..

- *French captain Henri Debrus*, promoted the idea of organizing a sports competition exclusively for the army. With inspiration from the Dutch Air Force, which had used specific military activities such as parachuting, marching, obstacle course, firing weapons and hand grenade to improve motor skills of these activities.

- Captain Debrus modified this training to the exercises we now to day, this was after 1946..

- The characteristics of the military pentathlon are closely related to the role of the military and the essential tasks undertaken by the armed forces, being a combination of the ability to concentrate, physical endurance and psychological challenges. 


- The one who masters all the events within the military pentathlon is the one who will excel both in sports AND on the battlefield, predicting the versatility (allsidighet) of the future military soldier
...
### Military skills and military pentathlon

::: {.fragment .fade-in-then-semi-out fragment-index=1}

- Each of the exercises can be related to a specific combat skill required in the operational theater / battlefield 
...
- **Obstacle course:** a way to prepare the soldier for the more difficult areas that they will sometimes have to go through to get to their destination.
  - It will also improve aerobic and anaerobic exercise capabilities, muscular endurance and strength and agility.
  - This will demand high degree of concentration
:::

::: {.fragment .fade-in-then-out fragment-index=3}

- **Obstacle swimming:** important movement process that allows the soldier to acquire the basic skills of survival in the water and crossing certain obstacles.
  - Improving aerobic exercise capacity, muscular endurance.
...
- **Throwing:** improves motor control and coordination of the movement (in-run, timing).  
  - Concentrate on motor control specific to the biomechanics of the precision throwing movement
  - This does not only apply throwing grenades, but other materials can be used, such as smoke bombs, first aid kits, ropes ect.

:::

::: {.fragment .fade-in-then-out fragment-index=5}

- **Running** in various terrains: this is in particular useful for the soldier, as it forms a series of skills specific to running on different terrains. 
  - It improves the aerobic capacity and cardiovascular system, and the soldier will also train on terrains similar to the environment in which they can meet on the battlefield.

:::

::: {.fragment .fade-in-then-out fragment-index=6}

- **Shooting:** Handle rifle appropriately, need to execute fire quickly and efficiently, to cope with scenarios at the battlefield. 
  - Precision shooting is essential for survival and to prevent unnecessary injuries.  
  - Concentration in stressful situations is necessary for success in the field

:::
:::

[@baitan_2021]{.absolute bottom=0 left=0 style="font-size: 70%;"}
...
![](images/exercise/obst.jpg){.fragment .fade-in-then-out fragment-index=2 .absolute top=250 right=0}

![](images/exercise/MP_swim.jpg){.fragment  .fade-in-then-out fragment-index=3}
![](images/exercise/throw.jpg){.fragment .fade-in-then-out fragment-index=4 .absolute top=250 right=-10 height="250" }

![](images/exercise/run-trond.jpg){.fragment .fade-in-then-out fragment-index=5 .absolute top=250 right=0 height="250"}

![](images/exercise/shoot.jpg){.fragment .fade-in-then-out fragment-index=6 .absolute top=250 right=-10 height="250" }
...
1.  - a concentration to tolerate some fatigue while performing technical maneuvers during obstacle course/swimming
  
3.   - the ability to concentrate on motor control specific to the biomechanics of the precicion throwing with hand grenades

4.  - the ability to concentrate in stressful situations is necessary during the firing of the individual equipment (especial during the 1 min round of 10 shoots)  
  

- The multi-athletic person which handle all the characteristics and physical demands will achieve the highest performance in all five elements  


----------

- A positive mental state
    - obtaining the pleasure of being committed in the activity, enjoy the activity, helps to achieve success and emphasizes the following: repeated competition and pleasure will lead to the acquisition of basic skills that the military will need. Furthermore, a winning mental attitude strengthens you not to give up when you set yourself a goal and encounter obstacles. This attitude (confidence, intelligence, work and perseverance), can be directly related to that of the military on the battlefield.

- Leadership: leader and the team must be effective and accessible to each other. Out of the need to improve performance, the leader must demonstrate empathy, a deeper understanding of each other team member, and its leadership must be based on trust and mutual respect. 
...
### Association to strength and endurance factors{style="font-size: 80%;"}
...
- So each of these exercises in military pentathlon can be related to a specific combat occupationl task required in the operational theater, 

and these skills are associated to your strength and endurance capacities..

    - markmansships, runing, jump skills, crawl, move fast, total laoding..
    
- So meaning, are you stronger you would also likely perform better in these military performance tasks...
...
- Military pentathlon exercises; markmanships, runing, jump skills, crawl, move fast... associated to pentathlon and capacitites
...
- What this really comes down to is that the military pentathlon is NOT just about sport — it’s about meeting real operational demands. These exercises are designed to sharpen your military readiness. And that readiness, at its core, depends on your physical fitness — on the strength and endurance you bring to the table.

SO, let us put military pentathlon into the military context and elaborate how it is related to your military readiness....

------------


- A strong argument for sustaining strength and endurance capacity during your academic life, or when deployed and will ensure military readiness
...
# The versatility of pentathlon in a military context {background-color="#107895"}



:::{.notes}

Versatility - allsidighet
...
- To set the military pentathlon in a military context and its relation to your military readiness, we must first define military operations, as this is what we continuously train TO prepare and be ready for...
...
![](fig/new/re2.png){.fragment height="350" fragment-index=2}
...
- AND THIS demand line is what you are training on during this week. The Demand of physical fitness that is related to your military occupational task performance, some are more or less linked to the military pentathlon exercises that you specifically are training on this week


- Draw the connection on the whiteboard.... linking it all toghether

Physical fitness --> military pentathlon --> military readiness / working demands


:::


## Cadet reflection: From Mission Readiness to the Military Pentathlon {background-color="#604461"}


{{< video https://www.youtube.com/watch?v=l0hRNblvefc&t=3s start="20" >}}

## Session 3: From the Military Pentathlon to Mission Readiness {background-color="#604461"}
...
- Ok, we now the connection between physical fitness, occupational tasks and military readiness, 

- so KNOW let us dig into some general demands that the modern soldier needs to cope with....which has evoled over the years
...
- This is mainly due to development of advanced protective body armor and weapon systems - which has lead to load carried on body has increased from around 5 kg up to 30 kg or more over the last 100 years..
...
- Instead of walking long distances to the enemy objectives, soldiers are now transported close to the target. Wherein the soldier, with combat gear are moving fast up/down buildings or terrain in offensive or defensive maneuvers. 
    - Bring in the aspect of sprinting to escape drones in Ukrainian (stories)...

- Consequently the anaerobic requirements is elevated, adding another demand on the soldier physical fitness capacity

- WHICH is also an important capacity in the obstacle course performance, with high intensity for a short time of period..
...
- SO an increased daily total loading, as you will experience by conducting all the military pentathlon exercises, is something you need to cope with to perform well in the pentathlon - a high load for a short time of period - and when put into a military context an important demand to handle to sustain your military readiness

:::


## Story from the Ukrainian battlefield ICSPP 2026 {.smaller background-color="#107895"}

### The intensity and complexity are exceptionally high

:::: {.columns}

::: {.column width="50%"}

- Killzone ~35 km (fluctuates)

- Maneuvering to the frontline:  
  - Load on body - 1.5 to 2 x body mass  
  - Sprinting  
  - Marching - high paceing  
  - Mental stress factor - continously  
...
- Duration - soldier turnover - 100 days in trenches!
    - SUSTAIN SUSTAIN
...
![](images/frontline.jpeg){.absolute height="350" top=130}
:::
...
How can you prepare for and adapt to the complex and demanding conditions you may encounter on the battlefield?

- The link to this weeks program

:::

::: {.notes}

Is these demands still valdid on the modern battlefield? As new technology is supporting the soldier in many ways to be effective and so on..
- Well, YES, in all sorts of ways....


This situation expose the soldier for multiple challenges:

Among others sleep deficit is a major problem, they never know for how long or when they can sleep, constantly under pressure...

- Sleep deficit

- So, let us see which and how stress factors affects soldiers operateive readiness physical and mental...


Every soldier is required to be a Force multiplier, more present, more capable and more resilient, how to we overcome that and succeed
...
- Reservists - new challange araises
    - not fit for service - lifestyle-health issues



Challenges with under-recruitment of new trainees and continued workforce outflows are reducing armed forces sizes, which means more is asked of fewer personnel. 
...
## Military operations {.smaller background-color="#604461"}
...
<br>
- Put heavy task into context, Ukrainian often need to carry equipment 1.5 to 2 times their own body weight.  

  - What do you need to meet such extreme demands, what is your opinion?  
...
![](fig/new/demand_heavy.png){.absolute height="250" bottom=-130 right=-50}



::: {.notes}

- All these demands which has increased gradually with the modern battlefield thus highlight the need for high physical fitness during military operations, and will thus also affect soldiers military readiness..

- However, there is more determinant factors that will affect soldiers military readiness and also challenge the maintenance of high physical fitness, which we will look into now..
:::
...
CADETS;
- Have you experienced these factors in your time of service? How did it affect your perforamnce and readiness?
...
- Warm climate can reduce performance with 5-7%
:::
...
![](fig/new/conc_stress.png){.fragment fragment-index=1 .fade-in-then-out .absolute height="450" left=-15 top=110}

![](fig/new/ex_envir1.png){.fragment fragment-index=2 .fade-in-then-out .absolute height="450" left=-15 top=110}

![](fig/new/rightside.png){.fragment fragment-index=3 .absolute height="450" left=-15 top=110}

:::


::: {.fragment fragment-index=1 .fade-in-then-out .absolute bottom=5 left=-15}

- Have you experienced these factors in your time of service? How did it affect your performance and readiness?
...
![](fig/solder_fucked.png){.absolute height="400"}
...
![](fig/solder_fucked_2.png){.absolute height="400"}
...
CADETS: Have all of your been through field exercises?  
IS these factors familiar to you, do you recognize these factors occurring during field exercises..?
...
![](fig/new/ex_envir1.png){.absolute height="350"}
...
- So being able to maintain its physical fitness level IS OF IMPORTANCE, as these stress-factors will induced negative physiological changes in periods during deployment and other operations, especial towards the RIGTH side of the continuum, and thus compromise soldiers physical performance and readiness
...
# Part two lecture {background-color="#107895"}
...
![](fig/new/ex_envir1.png){.absolute height="320" bottom=-180 right=0}
...
Ok, so let us look into possible training strategies to use, and what have been done before in some studies to improve and maintain physical fitness...

AND training strategies that have been implemented under these circumstances both under the LOW and HIGH conflict areas...
...
THESE training principles have Bent already delved into in the previous lecture and now we will put them into a military context...
...
- Shown to be an effective training model for enhancing physical fitness in athletes [@RN1029]
...
- In particular have the periodization model, block periodization, been recommended for soldiers to use both before and during deployment periods BUT also in your academic daily life this has a value, as your training may be interrupted by field exercises or other mandatory lectures interrupting your training continuity..
...
## Physical training during deployment - operations {.smaller background-color="#107895"}
...
![](fig/benefit/continuum.png){.fragment fragment-index=1 .fade-in-then-out .absolute height="350" left=0}


![](fig/new/strategies_low.png){.fragment fragment-index=2 .fade-in-then-out .absolute height="350" left=0}


![](fig/new/strategies_low_stress.png){.fragment fragment-index=3 .absolute height="350" left=0}
:::

::: {.fragment fragment-index=3 .absolute bottom=0}
...
- "click" But we know that the soldiers is in a challenging position, as the degree of the conflict continuum would vary with the present of single of multiple-stress factors that consequently would put the soldier in a more maladaptive state..

- "click" SO, where is it most optimal to train systematically, MOST likely in the left end of the conflict continuum, towards the stable peace conditions...

- "click", wherein the impact of each of these stress factors are lowest in intensity..

- this is where you are now, predominately, during your academy military education, but you will at occasions be tested of the impact of these stress factors during your education, I'll come back to that later in the lecture
...
Overall, all training groups improved:
...
- Another training strategy which can be implemented during deployment/ or when you are not in your usual training environment, is the task specific training, aligning with the idea of "train as you will fight."
...
- As we remember/know; these field exercises are exposing the soldier in combination of the stressors during non-deployment periods (POINT), to prepare and train the soldier for similar situation on the real-life battlefield.. I guess you all have participated in such field exercises and experienced what happens with your body, performance and hence readiness..??
...
::: {.incremental .absolute bottom=-150 }
- Optimizing recovery post operations - less studied
  - New studies needed!
  - 2027: Øfsteng & Rønnestad are launching a comprehensive study on recovery in soldiers. Stay tuned! 😊
...
"click" SO to increase motivation:  
    - maybe include frequent testing of physical fitness during deployment?  
...
::: {.fragment .absolute bottom=60}

- Reservists 
    - Training status may be an issue
    - Age of population
...
## The complex soldier {.smaller background-color="#107895"}

### Improving physical capasities starts now!
...
- So, already during this stay and during your academy training you can work on and increase your reserve capacity optimizing your operative readiness status.....
...
![](images/ex_envir1.png){.fragment .absolute top=-80 right=-30 height="280"}
...
- "click" and hence more likely manage to sustain physical fitness over time, to reduce/ or delay the the drop in fitness during more intense periods/operations and thereby optimizing your operational readiness...
...
- Then finally, we must highlight the benefit of maintainig high physical fitness as a soldier
...
# The benefit of high physical fitness over time and especial during deployment {background-color="#107895"}


::: {.notes}

Elaborate on this in Fallowfield et al., 2025.

- Military health provides the foundation for human performance, enhancement and/or augmentation, realising a more present, more capable and more resilient FORCE, hence SOLDIER.

- Valuing good health and human performance - providing benefits in monetary terms - should realise better support to Force readiness and enhance "people component" of operational effectiveness.
...
- We can look into short and long term benefit,

- HOWEVER, the short and long term benefit of maintained physical fitness need to be seen in conjunction with each other. As the long term benefit will dependent on how the short term benefits are achieved and sustained...
...
**Military pentathlon in the military context:**

- Military pentathlon exercises is part of your working demand

:::

:::{.fragment}

- These skills are dependent of your physical fitness 

:::

::: {.fragment}

- Important for sustaining military readiness over time (deployment - operations)
...
## Thank you for the attention {.smaller background-color="#107895"}

::: {.fragment .absolute bottom=-40 style="font-size: 120%;"}

[I hope this lecture has broadened your perspective on how military pentathlon exercises relate to your work demands and military readiness, and that it may serve as a tool to sharpen your training]{.bg style="--col: purple"}

:::

![](images/exercise/comb.png)
...
- and also a part of your military specific training - training specificity



 {.absolute top=-40 right=-60}

{{< video https://www.youtube.com/watch?v=TQ3P-XvOnFs&list=RDTQ3P-XvOnFs&start_radio=1 start="5"  width="350" height="250">}}
...
## Slides beyond, spare slides? {visibility="hidden"}



## Outline of talk {.smaller background-color="#107895" visibility="hidden"}
...
## Military operations {.smaller background-color="#107895" visibility="hidden"}
...
## Prolonged operations in the literature {.smaller background-color="#107895" visibility="hidden"}
...
![](fig/iraq.png){.fragment .fade-in fragment-index=3 .absolute right=0 top=150 width="480" visibility="hidden"}
...
## What is seen during deployments in changes in physical fitness {.smaller background-color="#107895" visibility="hidden"}
...
## What is seen during deployment studies in changes in body composition {.smaller background-color="#107895" visibility="hidden"}
...
## Characteristics of deployment studies {.smaller background-color="#107895" visibility="hidden"}
...
## Why this drop in aerobic capacity {.smaller background-color="#107895" visibility="hidden"}
...
## Summary slide of deployments studies {.smaller background-color="#107895" visibility="hidden"}
...
## Physical training during deployment {.smaller background-color="#107895" visibility="hidden"}
