...
- Military pentathlon in the greater picture

- Determinants of military readiness

- Training strategies during deployment / operations to preserve physical fitness and military readiness

- Benefit of physical fitness for the soldier in the short and long-term perspective




- Working demand of a modern soldier
...
- Starts on the 1900th century with the modern pentathlon developed as a consequence of the Olympians and war time during WWI.

- Developed in 1946 with the exercises we know to day.
...
- Captain Debrus modified this training to the exercises we now to day.
...
This does not only apply throwing grenades, but other materials can be used, such as smoke bombs, first aid kits, ropes ect, that must be handled in a safe and dry area.
...
- **Running** in various terrains: this is in particular useful for the military, as it forms a series of skills specific to running on different terrains. 
  - It improves the aerobic capacity and cardiovascular system, and they will also train on terrains similar to the environment in which they can meet on the battlefield.
...
![](images/exercise/run.jpg){.fragment .fade-in-then-out fragment-index=5 .absolute top=250 right=0}

![](images/exercise/throw.jpg){.fragment .fade-in-then-out fragment-index=6 .absolute top=250 right=-10 height="250" }
...
- concentration: 
  ...
  - the ability to concentrate in stressful situations is necessary during the firing of the individual equipment (especial during the 1 min round of 10 shoots)

  - the ability to concentrate on motor control specific to the biomechanics of the precicion throwing with hand grenades
  
  - the ability to tolerate some fatigue while performing technical maneuvers during obstacle course/swimming
  
  - high aerobic capacity for obstacle course and terrain run performance
...
- "click", As we see the military readiness is dependent on a high physical fitness level irrespective of degree of conflict. This fitness status is built on the soldiers Strength and Endurance capacities (point).
...
## Thank you for attention {.smaller background-color="#107895"}

::: {.absolute bottom=-40 style="font-size: 120%;"}

[Hopefully, the lecture has emphasized the importance of military pentathlon exercises as an important part of your military training requirements]{.bg style="--col: purple"}
...
## Slides beyond, spare slides?



## Military operations and demands fall within military pentathlon

What you train on in pentathlons is of importance for the battlefield
