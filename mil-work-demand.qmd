...
Switching to part two looking into what are we actuallay training for with these exercises from military pentathlon....

2 part; Then from her and beyond military pentathlon, physical capacitites are put into a broader military context. With the purpose of emphazising the importance of physical fitness to improve and sustain military readiness
...
- Training principles and training strategies
...
![](fig/new/demand_heavy.png){.absolute height="250" bottom=30 right=-50}
...
![](fig/new/ex_envir1.png){.absolute height="350" top=80 right=0}
...
THESE training principles and others will be delved more into during the next lecture, for optimizing performance
